...
class Wallet(Base):
    ...
    outgoing_transactions: Mapped[list["Transaction"]] = relationship(foreign_keys=["Transaction.from_wallet_id"], back_populates="from_wallet")
    incoming_transactions: Mapped[list["Transaction"]] = relationship(foreign_keys=["Transaction.to_wallet_id"], back_populates="to_wallet")
...
class Transaction(Base):
    ...
    from_wallet: Mapped["Wallet"] = relationship(foreign_keys=[from_wallet_id], back_populates="outgoing_transactions")
    to_wallet: Mapped["Wallet"] = relationship(foreign_keys=[to_wallet_id], back_populates="incoming_transactions")